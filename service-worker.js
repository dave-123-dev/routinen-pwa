const CACHE='routinen-cache-v31';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icons/icon.svg','./styles/app.css?v=31','./styles/v27-task-buttons.css?v=31','./src/version.js','./src/emoji-map.js','./src/emoji.js','./src/pull-refresh.js','./src/app-v29.js?v=31','./src/app-v30.js?v=31','./src/notifications-v31.js?v=31','./src/app-v31.js?v=31'];
